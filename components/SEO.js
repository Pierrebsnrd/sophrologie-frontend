...
const SEO = ({
        ...
        "@graph": [
            {
                ...
                "description": "Sophrologue certifiée proposant un accompagnement personnalisé basé sur l'écoute, la bienveillance et le respect de l'individualité.",
            ...
            },
            {
                ...
                "description": "Site officiel de Stéphanie Habert, sophrologue certifiée à Villepreux. Prenez rendez-vous pour des séances de sophrologie personnalisées.",
                "publisher": {
                    "@id": "https://www.sophrologuevillepreux.fr/#person"
                },
                "potentialAction": {
                    ...
                    "target": {
                        "@type": "EntryPoint",
                        "urlTemplate": "https://www.sophrologuevillepreux.fr/search?q={search_term_string}"
                    },
        ...
        switch (pageType) {
            case 'about':
                return {
                    ...
                    "description": "Découvrez le parcours de Stéphanie Habert, sophrologue certifiée, chanteuse d'opéra reconvertie dans l'accompagnement thérapeutique.",
                    "significantLink": [
            ...
            case 'service':
                return {
                    ...
                    "description": "Accompagnement personnalisé en sophrologie pour la gestion du stress, l'amélioration du sommeil et le renforcement de la confiance en soi.",
                    "provider": {
                        "@id": "https://www.sophrologuevillepreux.fr/#person"
                    },
                    "areaServed": {
            ...
            case 'pricing':
                return {
                    ...
                    "description": "Tarifs des séances de sophrologie avec Stéphanie Habert",
                    "priceCurrency": "EUR",
            ...
            case 'ethics':
                return {
                    ...
                    "about": {
                        ...
                        "description": "Principes éthiques guidant la pratique de la sophrologie"
                    },
                    "mainEntity": {
                        "@type": "Article",
            ...
            case 'appointment':
                return {
                    ...
                    "description": "Réservez votre séance de sophrologie avec Stéphanie Habert",
    ...
    return (
        <Head>
            ...
            <meta property="og:site_name" content="Stéphanie Habert - Sophrologie Villepreux" />
