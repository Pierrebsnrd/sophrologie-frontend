...
import styles from "../styles/pages/Charte.module.css";
  ...
  return (
    <>
      <SEO
        ...
        description="Découvrez la charte éthique de Stéphanie Habert, sophrologue à Villepreux. Un engagement de respect, confidentialité et bienveillance pour un accompagnement de qualité."
        canonical="https://www.sophrologuevillepreux.fr/charte"
        ogImage="https://www.sophrologuevillepreux.fr/bannieres/charte.jpg"
        ogImageAlt="Charte éthique de Stéphanie Habert"
        pageType="ethics"
        keywords="charte éthique sophrologie, déontologie, confidentialité, respect, bienveillance"
      />
      <Header />
      <main>
          ...
          <div className={styles.content}>
            <section className={styles.charteSection}>
              <p className={styles.intro}>
                En tant que sophrologue, je m'engage à exercer ma pratique avec
                respect, bienveillance et responsabilité. Cette charte éthique
                définit les principes qui guident mon accompagnement des
                personnes vers un mieux-être physique, mental et émotionnel.
              </p>
              ...
              <section className={styles.conclusion}>
                <h3>Conclusion</h3>
                <p>
                  Cette charte constitue le socle de ma pratique. Elle reflète
                  mon engagement à accompagner chaque personne avec respect,
                  éthique et bienveillance.
                </p>
                <p>
                  Elle évoluera en fonction des besoins de mes clients et des
                  exigences de ma profession.
                </p>
              </section>
            </section>
          </div>
